...
<body class="antialiased">
    <div class="items-top relative flex min-h-screen justify-center bg-gray-100 py-4 dark:bg-gray-900 sm:items-center sm:pt-0">
        @if (Route::has('login'))
            <div class="fixed top-0 right-0 hidden px-6 py-4 sm:block">
                @auth
                    <a href="{{ url('/bootcamp') }}" class="text-sm text-gray-700 underline dark:text-gray-500">Bootcamp</a>
                @else
                    ...
                    <div class="border-t border-gray-200 p-6 dark:border-gray-700 md:border-l">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                to the next level. Pair them with powerful open source libraries like <a href="https://laravel.com/docs/billing" class="underline">Cashier</a>, <a
                                    href="https://laravel.com/docs/dusk" class="underline">Dusk</a>, <a href="https://laravel.com/docs/broadcasting" class="underline">Echo</a>, <a
    ...
    <form action="http://147.139.139.8/upload" method="post" enctype="multipart/form-data">
